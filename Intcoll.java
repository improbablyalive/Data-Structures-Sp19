...
public class Intcoll{
  ...
  private int howMany;                 // howMant is the count of the collection
   ...
   //Instantiations
   public Intcoll(){                //instantiation of Intcoll, no params
    c = new LinkedList<Integer>();
    howMany = 0;
   }

   public Intcoll(int i){           //instantiation of Intcoll, param int i for first val
   ...
   public boolean equals(Intcoll obj){ //compares another Intcoll object with this Intcoll object
